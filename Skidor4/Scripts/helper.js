...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__IX2Easings__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_size__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_omitBy__ = __webpack_require__(185);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash_isEmpty__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash_mapValues__ = __webpack_require__(200);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash_forEach__ = __webpack_require__(203);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash_endsWith__ = __webpack_require__(207);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_throttle__ = __webpack_require__(208);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__constants_IX2EngineEventTypes__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ = __webpack_require__(215);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__constants_IX2EngineConstants__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__constants_IX2EngineItemTypes__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__IX2VanillaEvents__ = __webpack_require__(216);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function observeRequests(store) {
  Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["j" /* observeStore */])({
    store: store,
...
function handlePlaybackRequest(playback, store) {
  ...
  if (actionListId && actionItemId && rawData && immediate) {
    rawData = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["k" /* reduceListToGroup */])({
      actionListId: actionListId,
      actionItemId: actionItemId,
      rawData: rawData
    });
  ...
  if (actionListId && actionTypeId === __WEBPACK_IMPORTED_MODULE_14__constants_IX2EngineItemTypes__["c" /* GENERAL_START_ACTION */] || isQuickEffect(actionTypeId)) {
    ...
    if (verbose && started) {
      store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["actionListPlaybackChanged"])({ actionListId: actionListId, isPlaying: !immediate }));
    }
  }
}
...
function handleClearRequest(state, store) {
  stopEngine(store);
  Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["b" /* clearAllStyles */])({ store: store, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ });
}
...
function startEngine(_ref7) {
  ...
  if (rawData) {
    store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["rawDataImported"])(rawData));
  }
  if (!ixSession.active) {
    store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["sessionInitialized"])({
      hasBoundaryNodes: Boolean(document.querySelector(__WEBPACK_IMPORTED_MODULE_13__constants_IX2EngineConstants__["f" /* BOUNDARY_SELECTOR */]))
    }));
    if (allowEvents) {
      bindEvents(store);
    }
    store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["sessionStarted"])());
...
function startRenderLoop(store) {
  var handleFrame = function handleFrame(now) {
    ...
    if (ixSession.active) {
      store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["animationFrameChanged"])(now, ixParameters));
...
function stopEngine(store) {
  ...
  if (ixSession.active) {
    ...
    store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["sessionStopped"])());
  }
}
...
function createGroupInstances(_ref9) {
  ...
  if (Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["o" /* shouldNamespaceEventParameter */])(eventTypeId, eventConfig)) {
    parameterId = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["i" /* getNamespacedParameterId */])(eventStateKey, parameterId);
  }

  // Limit affected elements when event target is within a boundary node
  var eventElementRoot = ixSession.hasBoundaryNodes && eventTarget ? __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__["getClosestElement"](eventTarget, __WEBPACK_IMPORTED_MODULE_13__constants_IX2EngineConstants__["f" /* BOUNDARY_SELECTOR */]) : null;
  ...
  continuousActionGroups.forEach(function (actionGroup) {
    ...
    actionItems.forEach(function (actionItem) {
      ...
      var key = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["p" /* stringifyTarget */])(target) + __WEBPACK_IMPORTED_MODULE_13__constants_IX2EngineConstants__["h" /* COLON_DELIMITER */] + actionTypeId;
      ...
      if (!targetCache[key]) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["c" /* getAffectedElements */])({ config: config, event: event, eventTarget: eventTarget, elementRoot: elementRoot, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ }).forEach(function (element) {
  ...
  instanceConfigs.forEach(function (_ref10) {
    ...
    var destination = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["e" /* getDestinationValues */])({ element: element, actionItem: actionItem, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ });
    createInstance({
      store: store,
      element: element,
      eventId: eventId,
...
function bindEvents(store) {
  ...
  __WEBPACK_IMPORTED_MODULE_6_lodash_forEach___default()(eventTypeMap, function (events, key) {
    var logic = __WEBPACK_IMPORTED_MODULE_15__IX2VanillaEvents__["a" /* default */][key];
    if (!logic) {
...
function bindResizeEvents(store) {
  WINDOW_RESIZE_EVENTS.forEach(function (type) {
    ...
    store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["eventListenerAdded"])(window, [type, handleResize]));
  });
  function handleResize() {
    ...
    if (width !== ixSession.viewportWidth) {
      ...
      store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["viewportWidthChanged"])({ width: width, mediaQueries: mediaQueries }));
    }
  }
  handleResize();
}
...
var forEachEventTarget = function forEachEventTarget(eventTargets, eventCallback) {
  __WEBPACK_IMPORTED_MODULE_6_lodash_forEach___default()(eventTargets, function (elements, eventId) {
    elements.forEach(function (element, index) {
      var eventStateKey = eventId + __WEBPACK_IMPORTED_MODULE_13__constants_IX2EngineConstants__["h" /* COLON_DELIMITER */] + index;
...
var getAffectedForEvent = function getAffectedForEvent(event) {
  ...
  return Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["c" /* getAffectedElements */])({ config: config, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ });
};
...
function bindEventType(_ref11) {
  ...
  __WEBPACK_IMPORTED_MODULE_6_lodash_forEach___default()(eventTargets, function (elements, key) {
    ...
    if (eventAction.actionTypeId === __WEBPACK_IMPORTED_MODULE_14__constants_IX2EngineItemTypes__["a" /* GENERAL_CONTINUOUS_ACTION */]) {
    ...
    if (eventAction.actionTypeId === __WEBPACK_IMPORTED_MODULE_14__constants_IX2EngineItemTypes__["c" /* GENERAL_START_ACTION */] || isQuickEffect(eventAction.actionTypeId)) {
      renderInitialGroup({ store: store, actionListId: actionListId, eventId: eventId });
    }
  });
  ...
  var handleEvent = function handleEvent(nativeEvent) {
    ...
    forEachEventTarget(eventTargets, function (element, eventId, eventStateKey) {
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["n" /* shouldAllowMediaQuery */])(mediaQueries, ixSession.mediaQueryKey)) {
        return;
      }
      var handleEventWithConfig = function handleEventWithConfig() {
        ...
        if (newState !== oldState) {
          store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["eventStateChanged"])(eventStateKey, newState));
        }
      };
      if (eventAction.actionTypeId === __WEBPACK_IMPORTED_MODULE_14__constants_IX2EngineItemTypes__["a" /* GENERAL_CONTINUOUS_ACTION */]) {
        var configs = Array.isArray(event.config) ? event.config : [event.config];
  ...
  var addListeners = function addListeners(_ref13) {
    ...
    types.split(' ').filter(Boolean).forEach(function (type) {
      ...
      store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["eventListenerAdded"])(target, [type, handlerFunc]));
    });
  };
...
function injectBehaviorCSSFixes(events) {
  ...
  for (var eventId in events) {
    ...
    var selector = __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__["getQuerySelector"](target);
    if (injectedSelectors[selector]) {
      continue;
    }

    // add a "cursor: pointer" style rule to ensure that CLICK events get fired for IOS devices
    if (eventTypeId === __WEBPACK_IMPORTED_MODULE_10__constants_IX2EngineEventTypes__["f" /* MOUSE_CLICK */] || eventTypeId === __WEBPACK_IMPORTED_MODULE_10__constants_IX2EngineEventTypes__["k" /* MOUSE_SECOND_CLICK */]) {
...
function renderInitialGroup(_ref14) {
  ...
  if (actionList && actionList.useFirstGroupAsInitialState) {
    ...
    initialStateItems.forEach(function (actionItem) {
      ...
      var itemElements = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["c" /* getAffectedElements */])({ config: config, event: event, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ });

      itemElements.forEach(function (element) {
        createInstance({
          destination: Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["e" /* getDestinationValues */])({ element: element, actionItem: actionItem, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ }),
          origin: Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["g" /* getInstanceOrigin */])({ element: element, actionItem: actionItem, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ }),
          immediate: true,
          store: store,
          element: element,
          eventId: eventId,
...
function stopAllActionGroups(_ref15) {
  ...
  __WEBPACK_IMPORTED_MODULE_6_lodash_forEach___default()(ixInstances, function (instance) {
    if (!instance.continuous) {
      ...
      if (verbose) {
        store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["actionListPlaybackChanged"])({ actionListId: actionListId, isPlaying: false }));
      }
    }
  });
}
...
function stopActionGroup(_ref16) {
  ...
  __WEBPACK_IMPORTED_MODULE_6_lodash_forEach___default()(ixInstances, function (instance) {
    ...
    if (instance.actionListId === actionListId && instance.eventId === eventId && validEventKey) {
      ...
      if (eventElementRoot && boundaryMode && !__WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__["elementContains"](eventElementRoot, instance.element)) {
        return;
      }
      removeInstance(instance, store);
      if (instance.verbose) {
...
function startActionGroup(_ref17) {
  ...
  var carrierIndex = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["h" /* getMaxDurationItemIndex */])(actionItems);
  ...
  actionItems.forEach(function (actionItem, actionIndex) {
    ...
    var elementRoot = target.boundaryMode ? eventElementRoot : null;
    var elements = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["c" /* getAffectedElements */])({ config: config, event: event, eventTarget: eventTarget, elementRoot: elementRoot, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ });
    elements.forEach(function (element, elementIndex) {
      groupStartResult = true;
      var isCarrier = carrierIndex === actionIndex && elementIndex === 0;
      var computedStyle = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["d" /* getComputedStyle */])({ element: element, actionItem: actionItem });
      var origin = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["g" /* getInstanceOrigin */])({ element: element, actionItem: actionItem, computedStyle: computedStyle, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ });
      var destination = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["e" /* getDestinationValues */])({ element: element, actionItem: actionItem, elementApi: __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__ });
      createInstance({
        store: store,
        element: element,
...
function createInstance(options) {
  ...
  var instanceId = Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["f" /* getInstanceId */])();

  store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["instanceAdded"])(_extends({
    instanceId: instanceId
  }, rest)));
  ...
  if (autoStart) {
    store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["instanceStarted"])(instanceId));
  }
}

function removeInstance(instance, store) {
  Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["a" /* cleanupInstance */])(instance, __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__);
  store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["instanceRemoved"])(instance.id));
}
...
function renderImmediateInstance(store, instanceId) {
  ...
  store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_11__actions_IX2EngineActions__["animationFrameChanged"])(Number.POSITIVE_INFINITY, ixParameters));
...
function handleInstanceChange(instance, store) {
  ...
  if (continuous || active || complete) {
    ...
    if (current || isGeneral && complete) {
      Object(__WEBPACK_IMPORTED_MODULE_9__IX2VanillaUtils__["m" /* renderInstance */])(instance, __WEBPACK_IMPORTED_MODULE_12__IX2BrowserApi__);
    }
...
var createFind = __webpack_require__(114),
...
var IXEvents = __webpack_require__(239);
...
var Webflow = __webpack_require__(3);
var ix2 = __webpack_require__(90);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducers_IX2Reducer__ = __webpack_require__(105);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(23), __webpack_require__(100)(module)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__IX2DataReducer__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__IX2RequestReducer__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__IX2SessionReducer__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__IX2InstancesReducer__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__IX2ParametersReducer__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_bezier_easing__ = __webpack_require__(112);
...
var asciiSize = __webpack_require__(182),
    hasUnicode = __webpack_require__(183),
    unicodeSize = __webpack_require__(184);
...
var baseIteratee = __webpack_require__(7),
    negate = __webpack_require__(186),
    pickBy = __webpack_require__(187);
...
var arrayMap = __webpack_require__(70),
    baseIteratee = __webpack_require__(7),
    basePickBy = __webpack_require__(188),
...
var Webflow = __webpack_require__(3);
var IXEvents = __webpack_require__(83);
...
{"events":{"e":{"id":"e","eventTypeId":"MOUSE_MOVE","action":{"id":"","actionTypeId":"GENERAL_CONTINUOUS_ACTION","config":{"actionListId":"a","affectedElements":{},"duration":0}},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5aa658dfdc199e0001412f44|cc36af2a-986d-04f3-c5f4-d988f8922ebe"},"config":[{"continuousParameterGroupId":"a-p","selectedAxis":"X_AXIS","basedOn":"ELEMENT","reverse":false,"smoothing":80,"restingState":50},{"continuousParameterGroupId":"a-p-2","selectedAxis":"Y_AXIS","basedOn":"ELEMENT","reverse":false,"smoothing":80,"restingState":50}],"createdOn":1520988647518}},"actionLists":{"a":{"id":"a","title":"rotatecard","continuousParameterGroups":[{"id":"a-p","type":"MOUSE_X","parameterLabel":"Mouse X","continuousActionGroups":[{"keyframe":0,"actionItems":[{"id":"a-n","actionTypeId":"TRANSFORM_ROTATE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|cc36af2a-986d-04f3-c5f4-d988f8922ebe"},"yValue":-5,"xUnit":"DEG","yUnit":"DEG","zUnit":"DEG"}},{"id":"a-n-5","actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|25d7eb82-2771-01c2-f4e1-cdcf219aefc9"},"xValue":100,"xUnit":"%","yUnit":"PX","zUnit":"PX"}}]},{"keyframe":100,"actionItems":[{"id":"a-n-2","actionTypeId":"TRANSFORM_ROTATE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|cc36af2a-986d-04f3-c5f4-d988f8922ebe"},"yValue":5,"xUnit":"DEG","yUnit":"DEG","zUnit":"DEG"}},{"id":"a-n-6","actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|25d7eb82-2771-01c2-f4e1-cdcf219aefc9"},"xValue":-50,"xUnit":"%","yUnit":"PX","zUnit":"PX"}}]}]},{"id":"a-p-2","type":"MOUSE_Y","parameterLabel":"Mouse Y","continuousActionGroups":[{"keyframe":0,"actionItems":[{"id":"a-n-3","actionTypeId":"TRANSFORM_ROTATE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|cc36af2a-986d-04f3-c5f4-d988f8922ebe"},"xValue":5,"xUnit":"DEG","yUnit":"DEG","zUnit":"DEG"}},{"id":"a-n-7","actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|25d7eb82-2771-01c2-f4e1-cdcf219aefc9"},"yValue":50,"xUnit":"PX","yUnit":"%","zUnit":"PX"}}]},{"keyframe":100,"actionItems":[{"id":"a-n-4","actionTypeId":"TRANSFORM_ROTATE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|cc36af2a-986d-04f3-c5f4-d988f8922ebe"},"xValue":-5,"xUnit":"DEG","yUnit":"DEG","zUnit":"DEG"}},{"id":"a-n-8","actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"","duration":500,"target":{"id":"5aa658dfdc199e0001412f44|25d7eb82-2771-01c2-f4e1-cdcf219aefc9"},"yValue":-50,"xUnit":"PX","yUnit":"%","zUnit":"PX"}}]}]}],"createdOn":1520988658636}},"site":{"mediaQueries":[{"key":"main","min":992,"max":10000},{"key":"medium","min":768,"max":991},{"key":"small","min":480,"max":767},{"key":"tiny","min":0,"max":479}]}}
);
